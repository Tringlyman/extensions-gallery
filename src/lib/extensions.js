...
export default [
	...
	{
		name: "Zod",
		description: "adds runtime checks in penguinmod using zod npm package.",
		code: "Tringlyman/tringlymanZod.js",
		banner: "Tringlyman/tringlymanZod.svg",
		creator: "tringlyman",
		isGitHub: true,
	},
	{
	...
	{
		name: "Class",
		description: "adds classes inside of penguinmod.",
		code: "Tringlyman/tringlymanClass.js",
		banner: "Tringlyman/tringlymanClass.svg",
		creator: "tringlyman",
		isGitHub: true,
	},
	{
		name: "Eruda",
		description: "adds eruda support.",
